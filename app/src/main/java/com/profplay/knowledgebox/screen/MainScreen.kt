...
fun MainScreen(name: String, navController: NavController) {
    ...
    Column (
        ...
        Row (
            ...
            MainButton("Knowledge Pool", Icons.Filled.MenuBook){navController.navigate("knowledge_pool_screen")}
        }
        Row (
            horizontalArrangement = Arrangement.SpaceAround,
            modifier = Modifier.fillMaxWidth(1f)
            ...
            MainButton("How to play",Icons.Filled.Help){ navController.navigate("how_to_play_screen") }
        }
        Row (
            horizontalArrangement = Arrangement.SpaceAround,
            modifier = Modifier.fillMaxWidth(1f)
